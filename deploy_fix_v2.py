...
mappings = [
    ("temp_TelegramMessageRepository_v2.java", r"src\main\java\com\okx\trading\repository\TelegramMessageRepository.java"),
    ("temp_TelegramController_v2.java", r"src\main\java\com\okx\trading\controller\TelegramController.java")
]
