...
mappings = [
    ("temp_TelegramChannelEntity.java", r"src\main\java\com\okx\trading\model\entity\TelegramChannelEntity.java"),
    ...
    ("temp_TelegramScraperService.java", r"src\main\java\com\okx\trading\service\impl\TelegramScraperService.java"),
